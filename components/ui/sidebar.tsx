  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-brand text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}
      >
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  ...
  return (
    <main
      ...
      style={{
        width: isMobile ? '100vw' : 'calc(100vw - 18rem)'
      }}
      {...props}
    />
  )
