  ...
  return (
    <div className={'w-full'}>
      ...
      <Button
        ...
        variant={'link'}
        size={'lg'}
        className='w-full hover:no-underline bg-brand rounded-lg h-auto py-4 text-sm text-dark font-medium hover:bg-brand/80'
      >
        <Link href={`/marketplace/${title}`}>Bid Now</Link>
      </Button>
    </div>
  )
}
